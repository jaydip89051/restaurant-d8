...
class PackagesFormsTest extends PackagesTestBase {
  ...
  public function testPackagesForm() {
    ...
    // We should see only one of the plugins because one requires another permission.
    ...
    // Log in with primary packages permission plus the custom package permission.
    ...
    // Since no states have been saved yet, only the login greeting package should
    // be enabled since that is the default.
